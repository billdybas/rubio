...
/**
 * Determines whether the provided string is a valid ISO 8601 Datetime String
 * @param  {String}  datetimeStr - String to test
 * @return {Boolean}
 */
export function isValidISO8601 (datetimeStr) {
