...
describe('Configurator', function () {
  describe('constructor', function () {
    it('Merges Internal Configuration Correctly', function () {
      ...
      assert.deepStrictEqual(c._config, expected)
    })
  ...
  describe('all', function () {
    ...
    it('Returns All Default Environment Variables When None Specified in Validators', function () {
      ...
      const e = c.all()
      assert(Object.keys(e).length === 1 && _.has(e, 'NODE_ENV') && e['NODE_ENV'] === 'test')
      // TODO: assert(_.size(e) === 1 && _.has(e, 'NODE_ENV') && e['NODE_ENV'] === 'test')
    })
    ...
    it('Returns All Default and Specified Environment Variables', function () {
      ...
      const e = c.all()
      assert(Object.keys(e).length === 2 && _.has(e, 'NODE_ENV') && e['NODE_ENV'] === 'test' && _.has(e, 'FOO') && e['FOO'] === 'BAR')
      // TODO: assert(_.size(e) === 2 && _.has(e, 'NODE_ENV') && e['NODE_ENV'] === 'test' && _.has(e, 'FOO') && e['FOO'] === 'BAR')
    })
  })
